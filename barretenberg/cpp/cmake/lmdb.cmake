...
ExternalProject_Add(
    ...
    BUILD_COMMAND ${CMAKE_COMMAND} -E env CC=${CMAKE_C_COMPILER}${CMAKE_C_COMPILER_ARG1} AR=${CMAKE_AR} make -e -C libraries/liblmdb "XCFLAGS=${CMAKE_C_FLAGS} -fPIC" liblmdb.a
    INSTALL_COMMAND ""
